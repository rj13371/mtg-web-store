...
export default function EventsDashboard() {
  ...
  const [dateAndTime, handleDateAndTimeChange, isValidDate] =
    useStateWithValidation((date) => validDate(date), "");
          ...
          <Form onSubmit={submitNewEvent}>
            ...
            <Form.Group className="mb-3" controlId="formBasicPassword">
              ...
              <Form.Control
                ...
                value={dateAndTime}
                type="text"
                placeholder="24/12/2019 09:15:00"
              />
            </Form.Group>
