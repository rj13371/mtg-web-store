        ...
        >
          ...
          <Navbar.Collapse>
            <Nav style={{ fontSize: "24px", marginLeft: "120px" }}>
              <Nav.Link style={{ marginRight: "20px" }} href="/events/">
                Events
              </Nav.Link>
              <Nav.Link style={{ marginRight: "20px" }} href="#features">
                Buylist
              </Nav.Link>
              <Nav.Link style={{ marginRight: "20px" }} href="/dashboard">
                Dashboard
              </Nav.Link>
