...
router.get(
  "/productsAndMtgCards",
  catchAsync(Products.searchAllMtgCardsAndProducts)
);
router.get(
  "/productName/:productName",
  catchAsync(Products.searchProductsByName)
); //SEARCH
router.post("/addproduct", catchAsync(Products.postProduct)); //ADD CARD

router.route("/:id").get(catchAsync(Products.getProductsById));

router.get(
  "/catagory/:catagoryName",
  catchAsync(Products.getProductsByCatagoryName)
);
